...
Page({
	...
	data:{
	  table:['user','goods','order','booking','income','payout','reward','options','coupon','share']
	},

	// 用户表 user
	user:{
		"schema":[  
			{name:"unionid", type:'string', option:{length:80, unique:true, require:true }, acl:"w:-:-" },
			{name:"openid", type:'string', option:{length:80, index:true }, acl:"w:-:-" },
			{name:"nickName", type:'string', option:{length:100}, acl:"rw:r:r" },
			{name:"gender", type:'string', option:{length:100}, acl:"rw:r:r" },
			{name:"language", type:'string', option:{length:100}, acl:"rw:r:r" },
			{name:"city", type:'string', option:{length:100}, acl:"rw:r:r" },
			{name:"avatarUrl", type:'string', option:{length:200}, acl:"rw:r:r" },
			{name:"group", type:'string', option:{length:80, 'default':'manager'}, acl:"rw:r:r" },
			{name:"isadmin", type:'boolean', option:{length:10}, acl:"r:r:r" },
			{name:"type", type:'string', option:{length:20}, acl:"rw:rw:r" },
			{name:"cid", type:'string', option:{length:20,index:true}, acl:"rw:r:r" },
			{name:"sn", type:'string', option:{length:20,index:true}, acl:"rw:r:r" },
			{name:"name", type:'string', option:{length:80}, acl:"rw:rw:r" },
			{name:"mobile", type:'string', option:{length:20, unique:true}, acl:"rw:rw:r" },
			{name:"addr_01", type:'string', option:{length:200}, acl:"rw:rw:r" },
			{name:"addr_02", type:'string', option:{length:200}, acl:"rw:rw:r" }
		],
		
		"option":{ 
			record:"rwd:rw:-", table:"rwd:rwd:-", field:'rwd:rw:r',  user:'admin', group:'manager' 
		}
	...
	income:{
		"schema":[  
			{name:"sn", type:'string', option:{length:128, require:true }, acl:"rw:rw:r" },
			{name:"order_sn", type:'string', option:{length:128, require:true }, acl:"rw:rw:r" },
			{name:"uid", type:'integer', option:{length:10, require:true}, acl:"rw:rw:r" },
			{name:"amount", type:'integer', option:{length:10, require:true}, acl:"rw:rw:r" },
			{name:"amount_free", type:'integer', option:{length:10, require:true}, acl:"rw:rw:r" },
			{name:"status", type:'string', option:{length:10, index:true }, acl:"rw:rw:r" },
			{name:"status_tips", type:'string', option:{ length:200 }, acl:"rw:rw:r" }
		],
		"option":{ 
	...
	coupon:{
		"schema":[  
			{name:"uid", type:'integer', option:{length:10, require:true}, acl:"rw:rw:r" },
			{name:"code", type:'string', option:{length:20, require:true}, acl:"rw:rw:r" },
			{name:"category", type:'string', option:{length:20, require:true}, acl:"rw:rw:r" },
			{name:"quota", type:'string', option:{length:64, index:true }, acl:"rw:rw:r" },
			{name:"expire", type:'string', option:{ length:64 }, acl:"rw:rw:r" },
			{name:"status", type:'integer', option:{length:10, index:true }, acl:"rw:rw:r" }
		],	
		"option":{ 
			record:"rwd:rwd:rw", table:"rwd:rwd:-", field:'rwd:rwd:-',  user:'admin', group:'manager' 
		}
	...
	share:{
		"schema":[  
			{name:"shareuid", type:'integer', option:{length:10, require:true}, acl:"rw:rw:r" },
			{name:"uid", type:'integer', option:{length:10, require:true}, acl:"rw:rw:r" },
			{name:"code", type:'string', option:{length:20, require:true}, acl:"rw:rw:r" },
			{name:"category", type:'string', option:{length:20, require:true}, acl:"rw:rw:r" },
			{name:"amount", type:'integer', option:{length:10, index:true }, acl:"rw:rw:r" },
			{name:"status", type:'integer', option:{length:10, index:true }, acl:"rw:rw:r" }
		],	
		"option":{ 
			record:"rwd:rwd:rw", table:"rwd:rwd:-", field:'rwd:rwd:-',  user:'admin', group:'manager' 
	...
	options:{
		"schema":[  
			{name:"member", type:'text', option:{json:true}, acl:"rw:rw:r" }
		],
		"option":{ 
			record:"rwd:rwd:rw", table:"rwd:rwd:-", field:'rwd:rwd:-',  user:'admin', group:'manager' 
		}
